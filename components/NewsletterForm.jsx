...
<div className="flex flex-col items-center w-full p-8 bg-sky-400  rounded-sm mt-8">
      <h3 className="text-3xl font-bold text-center mb-8 text-black">Subscribe to our Newsletter</h3>
      <div className=" flex newsletter-input-fields">
        ...
        <div className="button-wrap wp-block-button px-4">
          <button className="cursor-pointer	text-black bg-indigo-500 border-0 py-2 px-5 focus:outline-none hover:bg-indigo-600 rounded" onClick={handleFormSubmit}>
            Submit
          </button>
        </div>
      </div>
