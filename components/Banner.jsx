  ...
  return (
   ...
   <div  className ='min-h-[83vh] bg-[url("/sports2.jpg")] bg-cover flex items-center lg:justify-start justify-center lg: lg:text-start text-center mb-10'  style={{}}>
        ...
        <div className='text-5xl text-white lg:pl-[120px] p-5'>
          <h2 className='text-5xl font-bold text-rose-900'>Sports Blog</h2>
          <span className='block py-3 text-xl max-sm:text-xl font-bold text-rose-800'>How much do you love sports? Let us explore it!</span>
          <button className='bg-blue-400 text-sm	border-none px-6 py-2 border max-sm:text-xl font-bold text-black'>
